...
var setPlayerOneScore = function (input) {
  ...
  if (input == "1") {
    ...
    console.log("PlayerOne Score", playerOneScore);
    gameMode = "playerTwoRollDice";
    console.log("gameMode PlayerTwoRollDice Set");
    return playerOneChoice();
...
var getWinner = function () {
  playerOneFinalScore = Number(playerOneFinalScore);
  playerTwoFinalScore = Number(playerTwoFinalScore);
  console.log(playerOneFinalScore);
  console.log(playerTwoFinalScore);
  winningNumber = Math.max(playerOneFinalScore, playerTwoFinalScore);
  if ((winningNumber = playerOneFinalScore)) {
    var player = "player1";
  } else var player = "player2";

  return "the top combine number is " + player;
};
...
var main = function (input) {
  ...
  } else if (gameMode === "getWinner") {
    console.log("getWinner mode");
